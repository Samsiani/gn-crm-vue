...
define( 'CIG_VERSION', '4.4.83' );
define( 'CIG_DB_VERSION', '1.8' );
...
require_once CIG_PLUGIN_DIR . 'api/class-cig-import-controller.php';
...
add_action( 'plugins_loaded', function() {
    ...
    if ( get_option( 'cig_db_version' ) !== CIG_DB_VERSION ) {
        ...
        CIG_Activator::add_other_deliveries_table();
